          ...
          {product.map((item, index) => {
            ...
            return (
              <div className="p-2 md:w-1/4 w-full" key={index}>
                <div
                  key={index}
                  className="bg-gray-200 p-3 rounded-2xl hover:scale-105 border border-emerald-700 transition ease-in-out cursor-pointer"
                >
                  ...
                  <div className=" flex  space-x-2 justify-between">
                    <button className="bg-[#444444] px-5 py-1.5 text-white rounded-lg"></button>
                    <button className="bg-[#4c050b] px-5 py-1.5 text-white rounded-lg"></button>
                  </div>
                </div>
              </div>
            );
